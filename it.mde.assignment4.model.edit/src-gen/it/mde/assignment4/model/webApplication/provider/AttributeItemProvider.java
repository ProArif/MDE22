...
/**
 * This is the item provider adapter for a {@link it.mde.assignment4.model.webApplication.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_type_feature",
								"_UI_Attribute_type"),
						WebApplicationPackage.Literals.ATTRIBUTE__TYPE, true, false, false,
	...
	protected void addIsPrimaryKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Attribute_isPrimaryKey_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isPrimaryKey_feature",
								"_UI_Attribute_type"),
						WebApplicationPackage.Literals.ATTRIBUTE__IS_PRIMARY_KEY, true, false, false,
