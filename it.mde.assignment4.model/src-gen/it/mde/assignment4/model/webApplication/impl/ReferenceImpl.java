 ...
 * </p>
 * <ul>
 *   <li>{@link it.mde.assignment4.model.webApplication.impl.ReferenceImpl#getForeignKey <em>Foreign Key</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends NamedElementImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return WebApplicationPackage.Literals.REFERENCE;
	}
			...
			if (foreignKey != oldForeignKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							WebApplicationPackage.REFERENCE__FOREIGN_KEY, oldForeignKey, foreignKey));
			}
		}
		return foreignKey;
	}
	...
	public void setForeignKey(Entity newForeignKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebApplicationPackage.REFERENCE__FOREIGN_KEY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WebApplicationPackage.REFERENCE__FOREIGN_KEY:
			if (resolve)
